...
public class Snake extends Creature{
    ...
    public Snake(Integer blood, Integer magic, Integer priority, myImage image, Screen screen, Integer id) {
        super(blood, magic, priority, image, screen, ECreatureType.蛇精, id);
    }
    ...
    public void attack(){
        if (Hlib.distanceBetween(this.position, nearestEnemy.getPosition()) >= 2)
            return;
        Stateinfo sinfo = new Stateinfo();
        sinfo.setBlood(random.nextInt(100)+90);
